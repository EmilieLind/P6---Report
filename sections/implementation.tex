...
The MoSCoW method is used to define minimum implementation requirements by sorting various features for the concept by priority. The \textit{Will not have} category is excluded from this version of the model. The MoSCoW priorities are as follows:\\
...
\item Realistic looking light based on information gathered online regarding weather and time of day
\end{itemize}
